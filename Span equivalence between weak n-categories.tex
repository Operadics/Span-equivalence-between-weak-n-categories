...
Let ${\cal A}={\bf Set}$, the induced monad $T_1$ is the free strict $1$-category monad, ${\bf Set} \mathchar`- {\bf Grp}$ is the category ${\bf GSet}$ of $1$-globular sets. By the remark,
\[
T_1 \mathchar`- {\bf Alg} = {\bf GSet}^{T_1} \cong {\bf Cat}
\]
