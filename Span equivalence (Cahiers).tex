...
{\bf Keywords.} Algebras for operads, Span equivalence.\\
...
In Section 2 we recall the preliminary definitions (globular sets, thier maps, operads, algebras for a operad). In Section 3 we define {\em span equivalence} and prove first theorem. In Section 4 we define span equivalence of ordinary categories and equivalence fusion, then we prove second theorem.
...
ematical Society Lecture Note Series. Cambridge University Press, Cambridge, 2004.
 \bibitem{T1}[TTT] Michael Barr and Charles Wells, TOPOSES, TRIPLES AND THEORRIES. Reprint in Theory and Applications of Categories, No. 12, 2005, pp. 1-288.
\end{thebibliography}
