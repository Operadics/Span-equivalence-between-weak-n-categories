...
x & {\rm (}x \in {\cal B}{\rm )} \\
\end{array} \right. $ \\
 hom-functions $v:{\bf Hom}{\rm (}x,y{\rm )} \longrightarrow {\cal B}{\rm (}ux,uy{\rm )}$縲�\\
...
I am particularly grateful for the comments given by professor Miyoshi Hiroyuki, Division of Science, Kyoto Sangyo University. His comments were invaluable.
